...
% Descrição
        % O algoritmo moesp_pi estima as matrizes de modelos na representação espaço de estados
        % sem tratar ruído de processo. Também pode ser utilizado para determinar a ordem do sistema.
% Dados de Entrada
        ...
        % sistema tenha e nusaida é o número de saídas que o sistema possui. Esta relação é definida de
